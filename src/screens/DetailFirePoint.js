      ...
      <ScrollView
        ...
        <VStack>
          ...
          <Box
            ...
            <Stack direction="row" justifyContent="space-between">
              <Text>Độ sáng: </Text>
              <Text> {properties.BRIGHTNESS}</Text>
            </Stack>
          </Box>
          <Box
            borderBottomWidth="1"
          ...
          <Box
            ...
            <Stack direction="row" justifyContent="space-between">
              <Text>Vệ tinh: </Text>
              <Text> {properties.SATELLITE}</Text>
            </Stack>
          </Box>
          <Box
            borderBottomWidth="1"
            ...
            <Stack direction="row" justifyContent="space-between">
              ...
              <Text> {properties.CONFIDENCE}</Text>
            </Stack>
          </Box>
          <Box
            borderBottomWidth="1"
          ...
          <Box
            ...
            <Stack direction="row" justifyContent="space-between">
              ...
              <Text> {properties.BRIGHT_T31}</Text>
            </Stack>
          </Box>
          <Box
            borderBottomWidth="1"
            ...
            <Stack direction="row" justifyContent="space-between">
              ...
              <Text>
                ...
                {properties.XACMINH == 1
                  ? ' Chưa xác minh'
                  : properties.XACMINH == 2
                  ? ' Xác minh là cháy rừng'
                  : properties.XACMINH == 3
          ...
          <Box paddingY={4}>
            <Stack direction="row" justifyContent="space-between" space={3}>
              ...
              <Button
                height={Dimension.boxHeight(60)}
                flex={1}
                _text={{fontWeight: 'bold', fontSize: Dimension.fontSize(16)}}>
                Xem trên bản đồ
              </Button>
