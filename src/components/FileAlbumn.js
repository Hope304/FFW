...
import { detectFilePicker } from '../untils/mapFunc';
      ...
      return (
        <Pressable
          ...
          <View style={styles.dotsContainer}>
            <RoundBtn
              icon={idxExpandEqual ? require('../assets/images/up.png') : require('../assets/images/down.png')}
              w={'100%'}
              event={() => {
          ...
          {idxExpandEqual && (
            <View style={styles.expandContainer}>
              ...
              />
              <RoundBtn
                icon={item?.isVisible ? require('../assets/images/eye.png') : require('../assets/images/no-eye.png')}
                iconColor={Colors.WHITE}
                iconSize={20}
                pd={8}
                btnColor={
    ...
    <BottomSheet
      ...
      {files?.length === 0 ? (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <Image source={require('../assets/images/nofile.png')} style={{ width: 188, height: 188 }} />
        </View>
      ) : (
        <BottomSheetFlatList
          data={files}
